...
require (
	...
	github.com/open-feature/spec/specification/assets/provider-tck v0.0.0-20260912100158-009afe061794 // indirect
...
replace github.com/open-feature/go-sdk-contrib/providers/ofrep => ../
