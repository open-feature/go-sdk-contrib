...
//
//	mockgen -source=strategies.go -destination=../../internal/mocks/strategy_mock.go -package=mocks
//
...
import (
	...
	strategies "github.com/open-feature/go-sdk-contrib/providers/multi-provider/pkg/strategies"
...
func (m *MockStrategy) Name() strategies.EvaluationStrategy {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Name")
	ret0, _ := ret[0].(strategies.EvaluationStrategy)
	return ret0
}
