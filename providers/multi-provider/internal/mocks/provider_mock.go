...
// Source: github.com/open-feature/go-sdk@v1.14.1/openfeature/provider.go
//
// Generated by this command:
//
//	mockgen -source=github.com/open-feature/go-sdk@v1.14.1/openfeature/provider.go -package=strategies -destination=./providers/multi-provider/internal/strategies/provider_mock.go
//
...
func (m *MockTracker) Track(ctx context.Context, trackingEventName string, evaluationContext openfeature.EvaluationContext, details openfeature.TrackingEventDetails) {
	m.ctrl.T.Helper()
