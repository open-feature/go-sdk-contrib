...
// Source: ./mocks/client-interface.go

// Package mock_grpc_service is a generated GoMock package.
...
func (m *MockServiceClient) ResolveNumber(ctx context.Context, in *schemav1.ResolveNumberRequest, opts ...grpc.CallOption) (*schemav1.ResolveNumberResponse, error) {
	...
	ret := m.ctrl.Call(m, "ResolveNumber", varargs...)
...
func (mr *MockServiceClientMockRecorder) ResolveNumber(ctx, in interface{}, opts ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, in}, opts...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ResolveNumber", reflect.TypeOf((*MockServiceClient)(nil).ResolveNumber), varargs...)
}
