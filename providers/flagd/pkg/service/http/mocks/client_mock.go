...
// Package mock_http_service is a generated GoMock package.
package mock_http_service
...
func (m *MockiHTTPClient) Request(method, url string, body io.Reader) (*http.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Request", method, url, body)
...
func (mr *MockiHTTPClientMockRecorder) Request(method, url, body interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Request", reflect.TypeOf((*MockiHTTPClient)(nil).Request), method, url, body)
}
