...
//			svcMock.EXPECT().ResolveBoolean(ctx, test.flagKey, test.defaultValue, test.evalCtx).
...
//		t.Run(test.name, func(t *testing.T) {
//			svcMock := mock.NewMockIService(ctrl)
//			svcMock.EXPECT().ResolveString(context.Background(), test.flagKey, test.defaultValue, test.evalCtx).Return(test.mockOut, test.mockError)
//
//			provider := Provider{
//				service: svcMock,
//			}
...
//		t.Run(test.name, func(t *testing.T) {
//			svcMock := mock.NewMockIService(ctrl)
//			svcMock.EXPECT().ResolveFloat(context.Background(), test.flagKey, test.defaultValue, test.evalCtx).Return(test.mockOut, test.mockError)
//
//			provider := Provider{
//				service: svcMock,
//			}
...
//	for _, test := range tests {
//		svcMock := mock.NewMockIService(ctrl)
//		svcMock.EXPECT().ResolveInt(context.Background(), test.flagKey, test.defaultValue, test.evalCtx).Return(test.mockOut,
//			test.mockError)
//
//		provider := Provider{
//			service: svcMock,
...
//		}
//
//		svcMock.EXPECT().ResolveObject(context.Background(), test.flagKey, test.defaultValue, test.evalCtx).Return(test.mockOut,
//			test.mockError)
//
//		provider := Provider{
//			service: svcMock,
