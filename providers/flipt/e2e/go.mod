...
require (
	...
	go.flipt.io/flipt/rpc/flipt v1.54.1-0.20260718011037-2ba78353193a // indirect
	go.flipt.io/flipt/sdk/go v0.13.1-0.20260718011037-2ba78353193a // indirect
...
replace github.com/open-feature/go-sdk-contrib/providers/flipt => ../
