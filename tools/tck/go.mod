module github.com/open-feature/go-sdk-contrib/tools/tck
...
require (
	...
	github.com/open-feature/spec/specification/assets/provider-tck v0.0.0-20260912211427-ccdb88790bb4
